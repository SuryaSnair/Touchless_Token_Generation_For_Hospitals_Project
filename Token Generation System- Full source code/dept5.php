...
<div class="header">
  <img src="pae.png" alt="logo" />
  <h1 style="color:powderblue;">Paediatrics Department</h1>
</div>
<?php

$conn=mysqli_connect("localhost","root","","token");
$query2=mysqli_query($conn,"SELECT * FROM paediatrics ");
...
<td><?php
if($r['Status']==0){
echo '<button class="button_1"><a href="status5.php?p_id=' .$r['p_id'].'&Status=1">Visit</a></button>';
  }
?></td>
