...
<section>
        <span class="colons"><a href="login.php"><i class="fa fa-sign-out" style="font-size:24px;color:black"></i></a></span> 
        <div class="container">
            <div class="time">
...
<img src="ca.jpg" width=450px height=80px></img>

<?php

$conn=mysqli_connect("localhost","root","","token");
$query2=mysqli_query($conn,"SELECT * FROM cardiology ");
...
<td><?php
if($r['Status']==0){
echo '<button class="button_1"><a href="status.php?c_id=' .$r['c_id'].'&Status=1">Visit</a></button>';
  }
?></td>
