...
<div class="header">
  <img src="onco.png" alt="logo" />
  <h1 style="color:powderblue;">Oncology Department</h1>
</div>
<?php

$conn=mysqli_connect("localhost","root","","token");
$query2=mysqli_query($conn,"SELECT * FROM oncology ");
...
<td><?php
if($r['Status']==0){
echo '<button class="button_1"><a href="status4.php?o_id=' .$r['o_id'].'&Status=1">Visit</a></button>';
  }
?></td>
