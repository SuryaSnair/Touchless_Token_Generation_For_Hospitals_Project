...
<div class="header">
  <img src="ent.png" alt="logo" />
  <h1 style="color:powderblue;">ENT Department</h1>
</div>
<?php

$conn=mysqli_connect("localhost","root","","token");
$query2=mysqli_query($conn,"SELECT * FROM ent ");
...
<td><?php
if($r['Status']==0){
echo '<button class="button_1"><a href="status3.php?e_id=' .$r['e_id'].'&Status=1">Visit</a></button>';
  }
?></td>
